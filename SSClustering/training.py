...
print('----------------------------------------------------------')
train_clustering_network3(num_epochs=60, n_neighbors=20, consider_distnaces=False, num_links=20000)
print('----------------------------------------------------------')
train_clustering_network3(num_epochs=60, n_neighbors=20, consider_distnaces=False, num_links=50000)
