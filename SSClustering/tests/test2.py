...
class val_augmentation:
    ...
    def __call__(self, x):
        return self.val_aug(x)



# backbone = resnet18()
# contrastivemodel = ContrastiveModel(backbone=backbone)
# file_path = 'C:/Users/Peter/PycharmProjects/Thesis/SSClustering/NeuralNets/simclr_cifar10.pth'

# checkpoint = torch.load(file_path)
# contrastivemodel.load_state_dict(checkpoint)

# clustermodel = ClusteringModel(backbone={'backbone': contrastivemodel.backbone, 'dim': contrastivemodel.backbone_dim}, nclusters=10)


# x = torch.randn(10, 3, 32, 32)
# aug = val_augmentation()
# preds = clustermodel.forward(aug(x))[0]
