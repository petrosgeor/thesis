...
class ResNet(nn.Module):
    def __init__(
        ...
        )  # Modified kernel_size, stride, and padding
        self.bn1 = norm_layer(self.inplanes)
        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)  # Modified kernel_size and stride
